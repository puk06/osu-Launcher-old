...
{
    public partial class OsuLauncher : Form
    {
        ...
        {
            osulaunch.Location = advancedSetting.Checked ? new Point(272, 392) : new Point(182, 213);
            ClientSize = advancedSetting.Checked ? new Size(675, 460) : new Size(533, 277);
